...
const SPLASH_CANVAS_COLOR = { r: 21, g: 21, b: 32, alpha: 1 }; // #151520 (matches HomePage)
...
async function main() {
  ...
  // Bake the #151520 spark-surface background into the PNG itself so the
  ...
  console.log(`  ✓ splash.png (${SPLASH_SIZE}x${SPLASH_SIZE}, logo ${Math.round(SPLASH_LOGO_FRACTION * 100)}%, baked #151520 canvas)`);
  ...
  console.log("    --splashBackgroundColor '#151520' \\");
  console.log("    --splashBackgroundColorDark '#151520'");
}
