...
internal object KnownCredentialsStore {
    ...
    private const val ESP_FILE = "breez.glow.knownCredentials"
     ...
     * fail to decode.
     */
    suspend fun read(context: Context, rpId: String): List<String> {
     ...
     */
    suspend fun add(context: Context, credentialIdBase64: String, rpId: String) {
     ...
     * stale.
     */
    suspend fun clear(context: Context, rpId: String) {
