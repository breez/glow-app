...
/// password whose attribute service is "breez.glow.knownCredentials" and
/// whose attribute account is the RP ID. The data blob is a JSON-encoded
/// array of base64-encoded credential IDs.
///
...
struct KnownCredentialsStore {
    private static let service = "breez.glow.knownCredentials"
    ...
    static func read(rpId: String) -> [String] {
    ...
    /// doesn't exist.
    static func add(credentialId: String, rpId: String) {
