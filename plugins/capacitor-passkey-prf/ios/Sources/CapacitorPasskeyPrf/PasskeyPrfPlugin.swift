...
public class PasskeyPlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    @objc func initialize(_ call: CAPPluginCall) {
        ...
        // The RP is ours to decide, not the WebView's. ASAuthorization would
        // reject a domain missing from our associated-domains entitlement
        // anyway, but only after showing the user a sheet naming that domain,
        // so a compromised WebView could still run a convincing phishing prompt.
